...
public class TestCaseBatch_3 extends ReconTestExecution {

	@Test(priority = 3, dependsOnMethods = "batch2")
	public static void batch3() {
		...
		// Invalid
		validatation.assertFalse(brsMap.containsKey(tc_1_utr),
				"The txn ("+tc_1_utr+") is present in the brs_complete file which should not be there on " + fileDate);
		...
		// Invalid
		validatation.assertFalse(brsMap.containsKey(tc_2_utr),
				"The txn ("+tc_2_utr+") is present in the brs_complete file which should not be there on " + fileDate);
		...
		// Invalid
		validatation.assertFalse(payloadWpayoutMap.containsKey(tc_3_payoutref),
				"The txn ("+tc_3_payoutref+") is present in payloadWoPayout which should not be there on " + fileDate);
		...
		// Invalid
		validatation.assertFalse(payloadWpayoutMap.containsKey(tc_11_payoutref),
				"The txn ("+tc_11_payoutref+") is present in payloadWoPayout which should not be there on " + fileDate);
		...
		// Invalid
		validatation.assertFalse(payloadWpayoutMap.containsKey(tc_12_payoutref),
				"The txn ("+tc_12_payoutref+") is present in payloadWoPayout which should not be there on " + fileDate);
