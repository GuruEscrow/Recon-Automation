...
public class TestCaseBatch_1 extends ReconTestExecution {

//------------------------Testing the batch1 test results-------------------
	@Test(priority = 1)
	public static void batch1() {
		...
		// validating the result based on there entry count in the files
		validateEntryCount();
		...
		//Valid
		validatation.assertTrue(brsMap.containsKey(tc_1_utr),
				"The txn ("+tc_1_utr+") is not present in the brs_complete file which should be there on " + fileDate);
		// Invalid
		validatation.assertFalse(cowostm.containsKey(tc_1_utr),
				"The txn ("+tc_1_utr+") is present in collect_wo_statement which should not be there on " + fileDate);
		...
		validatation.assertFalse(invalidBDMap.containsKey(tc_1_utr),
				"The txn ("+tc_1_utr+") is present in invalid bene details which should not be there on " + fileDate);
		...
		validatation.assertFalse(payloadWpayoutMap.containsKey(tc_1_payoutref),
				"The txn ("+tc_1_payoutref+") is present in payloadWoPayout which should not be there on " + fileDate);
		...
		validatation.assertFalse(stmWmfMap.containsKey(tc_1_utr),
				"The txn ("+tc_1_utr+") is present in stmWithMissingFiled which should not be there on " + fileDate);
		...
		//Valid
		validatation.assertTrue(brsMap.containsKey(tc_2_utr),
				"The txn ("+tc_2_utr+") is not present in the brs_complete file which should be there on " + fileDate);
		// Invalid
		validatation.assertFalse(cowostm.containsKey(tc_2_utr),
				"The txn ("+tc_2_utr+") is present in collect_wo_statement which should not be there on " + fileDate);
		...
		validatation.assertFalse(invalidBDMap.containsKey(tc_2_utr),
				"The txn ("+tc_2_utr+") is present in invalid bene details which should not be there on " + fileDate);
		...
		validatation.assertFalse(payloadWpayoutMap.containsKey(tc_2_payoutref),
				"The txn ("+tc_2_payoutref+") is present in payloadWoPayout which should not be there on " + fileDate);
		...
		validatation.assertFalse(stmWmfMap.containsKey(tc_2_utr),
				"The txn ("+tc_2_utr+") is present in stmWithMissingFiled which should not be there on " + fileDate);
		...
		// valid
		validatation.assertTrue(payloadWpayoutMap.containsKey(tc_3_payoutref),
				"The txn ("+tc_3_payoutref+") is not present in payloadWoPayout which should be there on " + fileDate);
		validatation.assertTrue(payoutWSMap.containsKey(tc_3_payoutref),
				"The txn ("+tc_3_payoutref+") is not present in payoutWoStm which should be there on " + fileDate);
		// Invalid
		validatation.assertFalse(brsMap.containsKey(tc_3_utr),
				"The txn ("+tc_3_utr+") is present in the brs_complete file which should not be there on " + fileDate);
		validatation.assertFalse(cowostm.containsKey(tc_3_utr),
				"The txn ("+tc_3_utr+") is present in collect_wo_statement which should not be there on " + fileDate);
		...
		validatation.assertFalse(invalidBDMap.containsKey(tc_3_utr),
				"The txn ("+tc_3_utr+") is present in invalid bene details which should not be there on " + fileDate);
		...
		validatation.assertFalse(stmWmfMap.containsKey(tc_3_utr),
				"The txn ("+tc_3_utr+") is present in stmWithMissingFiled which should not be there on " + fileDate);
		validatation.assertFalse(unresolvedStmMap.containsKey(tc_3_utr),
				"The txn ("+tc_3_utr+") is present in unresolvedStms which should not be there on " + fileDate);
		...
		// Invalid
		validatation.assertFalse(brsMap.containsKey(tc_4_utr),
				"The txn ("+tc_4_utr+") is present in the brs_complete file which should not be there on " + fileDate);
		validatation.assertFalse(cowostm.containsKey(tc_4_utr),
				"The txn ("+tc_4_utr+") is present in collect_wo_statement which should not be there on " + fileDate);
		...
		validatation.assertFalse(invalidBDMap.containsKey(tc_4_utr),
				"The txn ("+tc_4_utr+") is present in invalid bene details which should not be there on " + fileDate);
		...
		validatation.assertFalse(stmWmfMap.containsKey(tc_4_utr),
				"The txn ("+tc_4_utr+") is present in stmWithMissingFiled which should not be there on " + fileDate);
		...
		// Invalid
		validatation.assertFalse(brsMap.containsKey(tc_5_utr),
				"The txn ("+tc_5_utr+") is present in the brs_complete file which should not be there on " + fileDate);
		validatation.assertFalse(cowostm.containsKey(tc_5_utr),
				"The txn ("+tc_5_utr+") is present in collect_wo_statement which should not be there on " + fileDate);
		...
		validatation.assertFalse(invalidBDMap.containsKey(tc_5_utr),
				"The txn ("+tc_5_utr+") is present in invalid bene details which should not be there on " + fileDate);
		...
		validatation.assertFalse(payloadWpayoutMap.containsKey(tc_5_payoutref),
				"The txn ("+tc_5_payoutref+") is present in payloadWoPayout which should not be there on " + fileDate);
		...
		validatation.assertFalse(stmWmfMap.containsKey(tc_5_utr),
				"The txn ("+tc_5_utr+") is present in stmWithMissingFiled which should not be there on " + fileDate);
		...
		// valid
		// Invalid
		validatation.assertFalse(brsMap.containsKey(tc_6_utr),
				"The txn ("+tc_6_utr+") is present in the brs_complete file which should not be there on " + fileDate);
		validatation.assertFalse(cowostm.containsKey(tc_6_utr),
				"The txn ("+tc_6_utr+") is present in collect_wo_statement which should not be there on " + fileDate);
		...
		validatation.assertFalse(invalidBDMap.containsKey(tc_6_utr),
				"The txn ("+tc_6_utr+") is present in invalid bene details which should not be there on " + fileDate);
		...
		validatation.assertFalse(payloadWpayoutMap.containsKey(tc_6_payoutref),
				"The txn ("+tc_6_payoutref+") is present in payloadWoPayout which should not be there on " + fileDate);
		...
		validatation.assertFalse(powoplMap.containsKey(tc_6_utr),
				"The txn ("+tc_6_utr+") is present in payoutWoPayload which should not be there on " + fileDate);
		validatation.assertFalse(stmWmfMap.containsKey(tc_6_utr),
				"The txn ("+tc_6_utr+") is present in stmWithMissingFiled which should not be there on " + fileDate);
		...
		validatation.assertFalse(unresolvedStmMap.containsKey(tc_6_utr),
				"The txn ("+tc_6_utr+") is present in unresolvedStms which should not be there on " + fileDate);
		...
		// valid
		validatation.assertTrue(payloadWSMap.containsKey(tc_8_payoutref),
				"The txn ("+tc_8_payoutref+") is not present in payloadWoStm which should be there on " + fileDate);
		validatation.assertTrue(payoutWSMap.containsKey(tc_8_payoutref),
				"The txn ("+tc_8_payoutref+") is not present in payoutWoStm which should be there on " + fileDate);
		// Invalid
		validatation.assertFalse(brsMap.containsKey(tc_8_utr),
				"The txn ("+tc_8_utr+") is present in the brs_complete file which should not be there on " + fileDate);
		validatation.assertFalse(cowostm.containsKey(tc_8_utr),
				"The txn ("+tc_8_utr+") is present in collect_wo_statement which should not be there on " + fileDate);
		...
		validatation.assertFalse(invalidBDMap.containsKey(tc_8_utr),
				"The txn ("+tc_8_utr+") is present in invalid bene details which should not be there on " + fileDate);
		...
		validatation.assertFalse(payloadWpayoutMap.containsKey(tc_8_payoutref),
				"The txn ("+tc_8_payoutref+") is present in payloadWoPayout which should not be there on " + fileDate);
		...
		validatation.assertFalse(stmWmfMap.containsKey(tc_8_utr),
				"The txn ("+tc_8_utr+") is present in stmWithMissingFiled which should not be there on " + fileDate);
		...
		// valid
		validatation.assertTrue(payloadWSMap.containsKey(tc_9_payoutref),
				"The txn ("+tc_9_payoutref+") is not present in payloadWoStm which should be there on " + fileDate);
		validatation.assertTrue(payoutWSMap.containsKey(tc_9_payoutref),
				"The txn ("+tc_9_payoutref+") is not present in payoutWoStm which should be there on " + fileDate);
		// Invalid
		validatation.assertFalse(brsMap.containsKey(tc_9_utr),
				"The txn ("+tc_9_utr+") is present in the brs_complete file which should not be there on " + fileDate);
		validatation.assertFalse(cowostm.containsKey(tc_9_utr),
				"The txn ("+tc_9_utr+") is present in collect_wo_statement which should not be there on " + fileDate);
		...
		validatation.assertFalse(invalidBDMap.containsKey(tc_9_utr),
				"The txn ("+tc_9_utr+") is present in invalid bene details which should not be there on " + fileDate);
		...
		validatation.assertFalse(payloadWpayoutMap.containsKey(tc_9_payoutref),
				"The txn ("+tc_9_payoutref+") is present in payloadWoPayout which should not be there on " + fileDate);
		validatation.assertFalse(payoutWCMap.containsKey(tc_9_utr),
				"The txn ("+tc_9_utr+") is present in payoutWoCredit which should not be there on " + fileDate);
		...
		validatation.assertFalse(stmWmfMap.containsKey(tc_9_utr),
				"The txn ("+tc_9_utr+") is present in stmWithMissingFiled which should not be there on " + fileDate);
		...
		// valid
		validatation.assertTrue(payloadWpayoutMap.containsKey(tc_11_payoutref),
				"The txn ("+tc_11_payoutref+") is not present in payloadWoPayout which should be there on " + fileDate);
		validatation.assertTrue(payoutWSMap.containsKey(tc_11_payoutref),
				"The txn ("+tc_11_payoutref+") is not present in payoutWoStm which should be there on " + fileDate);
		// Invalid
		validatation.assertFalse(brsMap.containsKey(tc_11_utr),
				"The txn ("+tc_11_utr+") is present in the brs_complete file which should not be there on " + fileDate);
		validatation.assertFalse(cowostm.containsKey(tc_11_utr),
				"The txn ("+tc_11_utr+") is present in collect_wo_statement which should not be there on " + fileDate);
		...
		validatation.assertFalse(invalidBDMap.containsKey(tc_11_utr),
				"The txn ("+tc_11_utr+") is present in invalid bene details which should not be there on " + fileDate);
		...
		validatation.assertFalse(payloadWSMap.containsKey(tc_11_payoutref),
				"The txn ("+tc_11_payoutref+") is present in payloadWoStm which should not be there on " + fileDate);
		...
		validatation.assertFalse(stmWmfMap.containsKey(tc_11_utr),
				"The txn ("+tc_11_utr+") is present in stmWithMissingFiled which should not be there on " + fileDate);
		...
		// valid
		validatation.assertTrue(payloadWpayoutMap.containsKey(tc_12_payoutref),
				"The txn ("+tc_12_payoutref+") is not present in payloadWoPayout which should be there on " + fileDate);
		validatation.assertTrue(payoutWSMap.containsKey(tc_12_payoutref),
				"The txn ("+tc_12_payoutref+") is not present in payoutWoStm which should be there on " + fileDate);
		// Invalid
		validatation.assertFalse(brsMap.containsKey(tc_12_utr),
				"The txn ("+tc_12_utr+") is present in the brs_complete file which should not be there on " + fileDate);
		validatation.assertFalse(cowostm.containsKey(tc_12_utr),
				"The txn ("+tc_12_utr+") is present in collect_wo_statement which should not be there on " + fileDate);
		...
		validatation.assertFalse(invalidBDMap.containsKey(tc_12_utr),
				"The txn ("+tc_12_utr+") is present in invalid bene details which should not be there on " + fileDate);
		...
		validatation.assertFalse(payloadWSMap.containsKey(tc_12_payoutref),
				"The txn ("+tc_12_payoutref+") is present in payloadWoStm which should not be there on " + fileDate);
		...
		validatation.assertFalse(stmWmfMap.containsKey(tc_12_utr),
				"The txn ("+tc_12_utr+") is present in stmWithMissingFiled which should not be there on " + fileDate);
		...
		// valid
		validatation.assertTrue(payloadWSMap.containsKey(tc_14_payoutref),
				"The txn ("+tc_14_payoutref+") is not present in payloadWoStm which should be there on " + fileDate);
		validatation.assertTrue(payoutWSMap.containsKey(tc_14_payoutref),
				"The txn ("+tc_14_payoutref+") is not present in payoutWoStm which should be there on " + fileDate);
		// Invalid
		validatation.assertFalse(brsMap.containsKey(tc_14_utr),
				"The txn ("+tc_14_utr+") is present in the brs_complete file which should not be there on " + fileDate);
		validatation.assertFalse(cowostm.containsKey(tc_14_utr),
				"The txn ("+tc_14_utr+") is present in collect_wo_statement which should not be there on " + fileDate);
		...
		validatation.assertFalse(invalidBDMap.containsKey(tc_14_utr),
				"The txn ("+tc_14_utr+") is present in invalid bene details which should not be there on " + fileDate);
		...
		validatation.assertFalse(payloadWpayoutMap.containsKey(tc_14_payoutref),
				"The txn ("+tc_14_payoutref+") is present in payloadWoPayout which should not be there on " + fileDate);
		...
		validatation.assertFalse(stmWmfMap.containsKey(tc_14_utr),
				"The txn ("+tc_14_utr+") is present in stmWithMissingFiled which should not be there on " + fileDate);
		...
		// valid
		validatation.assertTrue(payloadWSMap.containsKey(tc_15_payoutref),
				"The txn ("+tc_15_payoutref+") is not present in payloadWoStm which should be there on " + fileDate);
		...
		// Invalid
		validatation.assertFalse(brsMap.containsKey(tc_15_utr),
				"The txn ("+tc_15_utr+") is present in the brs_complete file which should not be there on " + fileDate);
		validatation.assertFalse(cowostm.containsKey(tc_15_utr),
				"The txn ("+tc_15_utr+") is present in collect_wo_statement which should not be there on " + fileDate);
		...
		validatation.assertFalse(invalidBDMap.containsKey(tc_15_utr),
				"The txn ("+tc_15_utr+") is present in invalid bene details which should not be there on " + fileDate);
		...
		validatation.assertFalse(payloadWpayoutMap.containsKey(tc_15_payoutref),
				"The txn ("+tc_15_payoutref+") is present in payloadWoPayout which should not be there on " + fileDate);
		...
		validatation.assertFalse(stmWmfMap.containsKey(tc_15_utr),
				"The txn ("+tc_15_utr+") is present in stmWithMissingFiled which should not be there on " + fileDate);
		...
		// valid
		validatation.assertTrue(payloadWSMap.containsKey(tc_17_payoutref),
				"The txn ("+tc_17_payoutref+") is not present in payloadWoStm which should be there on " + fileDate);
		validatation.assertTrue(payoutWSMap.containsKey(tc_17_payoutref),
				"The txn ("+tc_17_payoutref+") is not present in payoutWoStm which should be there on " + fileDate);
		// Invalid
		validatation.assertFalse(brsMap.containsKey(tc_17_utr),
				"The txn ("+tc_17_utr+") is present in the brs_complete file which should not be there on " + fileDate);
		validatation.assertFalse(cowostm.containsKey(tc_17_utr),
				"The txn ("+tc_17_utr+") is present in collect_wo_statement which should not be there on " + fileDate);
		...
		validatation.assertFalse(invalidBDMap.containsKey(tc_17_utr),
				"The txn ("+tc_17_utr+") is present in invalid bene details which should not be there on " + fileDate);
		...
		validatation.assertFalse(payloadWpayoutMap.containsKey(tc_17_payoutref),
				"The txn ("+tc_17_payoutref+") is present in payloadWoPayout which should not be there on " + fileDate);
		...
		validatation.assertFalse(stmWmfMap.containsKey(tc_17_utr),
				"The txn ("+tc_17_utr+") is present in stmWithMissingFiled which should not be there on " + fileDate);
		...
		// valid
		validatation.assertTrue(payloadWSMap.containsKey(tc_18_payoutref),
				"The txn ("+tc_18_payoutref+") is not present in payloadWoStm which should be there on " + fileDate);
		validatation.assertTrue(payoutWSMap.containsKey(tc_18_payoutref),
				"The txn ("+tc_18_payoutref+") is not present in payoutWoStm which should be there on " + fileDate);
		// Invalid
		validatation.assertFalse(brsMap.containsKey(tc_18_utr),
				"The txn ("+tc_18_utr+") is present in the brs_complete file which should not be there on " + fileDate);
		validatation.assertFalse(cowostm.containsKey(tc_18_utr),
				"The txn ("+tc_18_utr+") is present in collect_wo_statement which should not be there on " + fileDate);
		...
		validatation.assertFalse(invalidBDMap.containsKey(tc_18_utr),
				"The txn ("+tc_18_utr+") is present in invalid bene details which should not be there on " + fileDate);
		...
		validatation.assertFalse(payloadWpayoutMap.containsKey(tc_18_payoutref),
				"The txn ("+tc_18_payoutref+") is present in payloadWoPayout which should not be there on " + fileDate);
		...
		validatation.assertFalse(stmWmfMap.containsKey(tc_18_utr),
				"The txn ("+tc_18_utr+") is present in stmWithMissingFiled which should not be there on " + fileDate);
		...
		// valid
		validatation.assertTrue(payloadWSMap.containsKey(tc_19_payoutref),
				"The txn ("+tc_19_payoutref+") is not present in payloadWoStm which should be there on " + fileDate);
		validatation.assertTrue(payoutWSMap.containsKey(tc_19_payoutref),
				"The txn ("+tc_19_payoutref+") is not present in payoutWoStm which should be there on " + fileDate);
		// Invalid
		validatation.assertFalse(brsMap.containsKey(tc_19_utr),
				"The txn ("+tc_19_utr+") is present in the brs_complete file which should not be there on " + fileDate);
		validatation.assertFalse(cowostm.containsKey(tc_19_utr),
				"The txn ("+tc_19_utr+") is present in collect_wo_statement which should not be there on " + fileDate);
		...
		validatation.assertFalse(invalidBDMap.containsKey(tc_19_utr),
				"The txn ("+tc_19_utr+") is present in invalid bene details which should not be there on " + fileDate);
		...
		validatation.assertFalse(payloadWpayoutMap.containsKey(tc_19_payoutref),
				"The txn ("+tc_19_payoutref+") is present in payloadWoPayout which should not be there on " + fileDate);
		...
		validatation.assertFalse(stmWmfMap.containsKey(tc_19_utr),
				"The txn ("+tc_19_utr+") is present in stmWithMissingFiled which should not be there on " + fileDate);
		...
		// valid
		validatation.assertTrue(payloadWSMap.containsKey(tc_20_payoutref),
				"The txn ("+tc_20_payoutref+") is not present in payloadWoStm which should be there on " + fileDate);
		validatation.assertTrue(payoutWSMap.containsKey(tc_20_payoutref),
				"The txn ("+tc_20_payoutref+") is not present in payoutWoStm which should be there on " + fileDate);
		// Invalid
		validatation.assertFalse(brsMap.containsKey(tc_20_utr),
				"The txn ("+tc_20_utr+") is present in the brs_complete file which should not be there on " + fileDate);
		validatation.assertFalse(cowostm.containsKey(tc_20_utr),
				"The txn ("+tc_20_utr+") is present in collect_wo_statement which should not be there on " + fileDate);
		...
		validatation.assertFalse(invalidBDMap.containsKey(tc_20_utr),
				"The txn ("+tc_20_utr+") is present in invalid bene details which should not be there on " + fileDate);
		...
		validatation.assertFalse(payloadWpayoutMap.containsKey(tc_20_payoutref),
				"The txn ("+tc_20_payoutref+") is present in payloadWoPayout which should not be there on " + fileDate);
		validatation.assertFalse(payoutWCMap.containsKey(tc_20_utr),
				"The txn ("+tc_20_utr+") is present in payoutWoCredit which should not be there on " + fileDate);
		...
		validatation.assertFalse(stmWmfMap.containsKey(tc_20_utr),
				"The txn ("+tc_20_utr+") is present in stmWithMissingFiled which should not be there on " + fileDate);
		...
		// valid
		validatation.assertTrue(payloadWSMap.containsKey(tc_21_payoutref),
				"The txn ("+tc_21_payoutref+") is not present in payloadWoStm which should be there on " + fileDate);
		validatation.assertTrue(payoutWSMap.containsKey(tc_21_payoutref),
				"The txn ("+tc_21_payoutref+") is not present in payoutWoStm which should be there on " + fileDate);
		// Invalid
		validatation.assertFalse(brsMap.containsKey(tc_21_utr),
				"The txn ("+tc_21_utr+") is present in the brs_complete file which should not be there on " + fileDate);
		validatation.assertFalse(cowostm.containsKey(tc_21_utr),
				"The txn ("+tc_21_utr+") is present in collect_wo_statement which should not be there on " + fileDate);
		...
		validatation.assertFalse(invalidBDMap.containsKey(tc_21_utr),
				"The txn ("+tc_21_utr+") is present in invalid bene details which should not be there on " + fileDate);
		...
		validatation.assertFalse(payloadWpayoutMap.containsKey(tc_21_payoutref),
				"The txn ("+tc_21_payoutref+") is present in payloadWoPayout which should not be there on " + fileDate);
		...
		validatation.assertFalse(stmWmfMap.containsKey(tc_21_utr),
				"The txn ("+tc_21_utr+") is present in stmWithMissingFiled which should not be there on " + fileDate);
		...
		// valid
		validatation.assertTrue(payloadWSMap.containsKey(tc_22_payoutref),
				"The txn ("+tc_22_payoutref+") is not present in payloadWoStm which should be there on " + fileDate);
		validatation.assertTrue(payoutWSMap.containsKey(tc_22_payoutref),
				"The txn ("+tc_22_payoutref+") is not present in payoutWoStm which should be there on " + fileDate);
		// Invalid
		validatation.assertFalse(brsMap.containsKey(tc_22_utr),
				"The txn ("+tc_22_utr+") is present in the brs_complete file which should not be there on " + fileDate);
		validatation.assertFalse(cowostm.containsKey(tc_22_utr),
				"The txn ("+tc_22_utr+") is present in collect_wo_statement which should not be there on " + fileDate);
		...
		validatation.assertFalse(invalidBDMap.containsKey(tc_22_utr),
				"The txn ("+tc_22_utr+") is present in invalid bene details which should not be there on " + fileDate);
		...
		validatation.assertFalse(payloadWpayoutMap.containsKey(tc_22_payoutref),
				"The txn ("+tc_22_payoutref+") is present in payloadWoPayout which should not be there on " + fileDate);
		...
		validatation.assertFalse(stmWmfMap.containsKey(tc_22_utr),
				"The txn ("+tc_22_utr+") is present in stmWithMissingFiled which should not be there on " + fileDate);
		...
		// valid
		validatation.assertTrue(payloadWSMap.containsKey(tc_23_payoutref),
				"The txn ("+tc_23_payoutref+") is not present in payloadWoStm which should be there on " + fileDate);
		validatation.assertTrue(payoutWSMap.containsKey(tc_23_payoutref),
				"The txn ("+tc_23_payoutref+") is not present in payoutWoStm which should be there on " + fileDate);
		// Invalid
		validatation.assertFalse(brsMap.containsKey(tc_23_utr),
				"The txn ("+tc_23_utr+") is present in the brs_complete file which should not be there on " + fileDate);
		validatation.assertFalse(cowostm.containsKey(tc_23_utr),
				"The txn ("+tc_23_utr+") is present in collect_wo_statement which should not be there on " + fileDate);
		...
		validatation.assertFalse(invalidBDMap.containsKey(tc_23_utr),
				"The txn ("+tc_23_utr+") is present in invalid bene details which should not be there on " + fileDate);
		...
		validatation.assertFalse(ppwmore1stmMap.containsKey(tc_23_utr),
				"The txn ("+tc_23_utr+") is present in ppwmore1stm which should not be there on " + fileDate);
		validatation.assertFalse(payloadWpayoutMap.containsKey(tc_23_payoutref),
				"The txn ("+tc_23_payoutref+") is present in payloadWoPayout which should not be there on " + fileDate);
		validatation.assertFalse(payoutWCMap.containsKey(tc_23_utr),
				"The txn ("+tc_23_utr+") is present in payoutWoCredit which should not be there on " + fileDate);
		...
		validatation.assertFalse(stmWmfMap.containsKey(tc_23_utr),
				"The txn ("+tc_23_utr+") is present in stmWithMissingFiled which should not be there on " + fileDate);
		...
		// valid
		validatation.assertTrue(payloadWSMap.containsKey(tc_24_payoutref),
				"The txn ("+tc_24_payoutref+") is not present in payloadWoStm which should be there on " + fileDate);
		...
		// Invalid
		validatation.assertFalse(brsMap.containsKey(tc_24_utr),
				"The txn ("+tc_24_utr+") is present in the brs_complete file which should not be there on " + fileDate);
		validatation.assertFalse(cowostm.containsKey(tc_24_utr),
				"The txn ("+tc_24_utr+") is present in collect_wo_statement which should not be there on " + fileDate);
		...
		validatation.assertFalse(invalidBDMap.containsKey(tc_24_utr),
				"The txn ("+tc_24_utr+") is present in invalid bene details which should not be there on " + fileDate);
		...
		validatation.assertFalse(payloadWpayoutMap.containsKey(tc_24_payoutref),
				"The txn ("+tc_24_payoutref+") is present in payloadWoPayout which should not be there on " + fileDate);
		...
		validatation.assertFalse(stmWmfMap.containsKey(tc_24_utr),
				"The txn ("+tc_24_utr+") is present in stmWithMissingFiled which should not be there on " + fileDate);
		...
		// valid
		validatation.assertTrue(payloadWSMap.containsKey(tc_25_payoutref),
				"The txn ("+tc_25_payoutref+") is not present in payloadWoStm which should be there on " + fileDate);
		validatation.assertTrue(payoutWSMap.containsKey(tc_25_payoutref),
				"The txn ("+tc_25_payoutref+") is not present in payoutWoStm which should be there on " + fileDate);
		// Invalid
		validatation.assertFalse(brsMap.containsKey(tc_25_utr),
				"The txn ("+tc_25_utr+") is present in the brs_complete file which should not be there on " + fileDate);
		validatation.assertFalse(cowostm.containsKey(tc_25_utr),
				"The txn ("+tc_25_utr+") is present in collect_wo_statement which should not be there on " + fileDate);
		...
		validatation.assertFalse(invalidBDMap.containsKey(tc_25_utr),
				"The txn ("+tc_25_utr+") is present in invalid bene details which should not be there on " + fileDate);
		...
		validatation.assertFalse(payloadWpayoutMap.containsKey(tc_25_payoutref),
				"The txn ("+tc_25_payoutref+") is present in payloadWoPayout which should not be there on " + fileDate);
		validatation.assertFalse(payoutWCMap.containsKey(tc_25_utr),
				"The txn ("+tc_25_utr+") is present in payoutWoCredit which should not be there on " + fileDate);
		...
		validatation.assertFalse(stmWmfMap.containsKey(tc_25_utr),
				"The txn ("+tc_25_utr+") is present in stmWithMissingFiled which should not be there on " + fileDate);
		...
		// valid
		validatation.assertTrue(payloadWSMap.containsKey(tc_27_payoutref),
				"The txn ("+tc_27_payoutref+") is not present in payloadWoStm which should be there on " + fileDate);
		validatation.assertTrue(payoutWSMap.containsKey(tc_27_payoutref),
				"The txn ("+tc_27_payoutref+") is not present in payoutWoStm which should be there on " + fileDate);
		// Invalid
		validatation.assertFalse(brsMap.containsKey(tc_27_utr),
				"The txn ("+tc_27_utr+") is present in the brs_complete file which should not be there on " + fileDate);
		validatation.assertFalse(cowostm.containsKey(tc_27_utr),
				"The txn ("+tc_27_utr+") is present in collect_wo_statement which should not be there on " + fileDate);
		...
		validatation.assertFalse(invalidBDMap.containsKey(tc_27_utr),
				"The txn ("+tc_27_utr+") is present in invalid bene details which should not be there on " + fileDate);
		...
		validatation.assertFalse(payloadWpayoutMap.containsKey(tc_27_payoutref),
				"The txn ("+tc_27_payoutref+") is present in payloadWoPayout which should not be there on " + fileDate);
		validatation.assertFalse(payoutWCMap.containsKey(tc_27_utr),
				"The txn ("+tc_27_utr+") is present in payoutWoCredit which should not be there on " + fileDate);
		...
		validatation.assertFalse(stmWmfMap.containsKey(tc_27_utr),
				"The txn ("+tc_27_utr+") is present in stmWithMissingFiled which should not be there on " + fileDate);
		...
		// valid
		validatation.assertTrue(payloadWSMap.containsKey(tc_29_payoutref),
				"The txn ("+tc_29_payoutref+") is not present in payloadWoStm which should be there on " + fileDate);
		validatation.assertTrue(payoutWSMap.containsKey(tc_29_payoutref),
				"The txn ("+tc_29_payoutref+") is not present in payoutWoStm which should be there on " + fileDate);
		// Invalid
		validatation.assertFalse(brsMap.containsKey(tc_29_utr),
				"The txn ("+tc_29_utr+") is present in the brs_complete file which should not be there on " + fileDate);
		validatation.assertFalse(cowostm.containsKey(tc_29_utr),
				"The txn ("+tc_29_utr+") is present in collect_wo_statement which should not be there on " + fileDate);
		...
		validatation.assertFalse(invalidBDMap.containsKey(tc_29_utr),
				"The txn ("+tc_29_utr+") is present in invalid bene details which should not be there on " + fileDate);
		...
		validatation.assertFalse(payloadWpayoutMap.containsKey(tc_29_payoutref),
				"The txn ("+tc_29_payoutref+") is present in payloadWoPayout which should not be there on " + fileDate);
		...
		validatation.assertFalse(stmWmfMap.containsKey(tc_29_utr),
				"The txn ("+tc_29_utr+") is present in stmWithMissingFiled which should not be there on " + fileDate);
		...
		// valid
		validatation.assertTrue(payloadWSMap.containsKey(tc_31_payoutref),
				"The txn ("+tc_31_payoutref+") is not present in payloadWoStm which should be there on " + fileDate);
		validatation.assertTrue(payoutWSMap.containsKey(tc_31_payoutref),
				"The txn ("+tc_31_payoutref+") is not present in payoutWoStm which should be there on " + fileDate);
		// Invalid
		validatation.assertFalse(brsMap.containsKey(tc_31_utr),
				"The txn ("+tc_31_utr+") is present in the brs_complete file which should not be there on " + fileDate);
		validatation.assertFalse(cowostm.containsKey(tc_31_utr),
				"The txn ("+tc_31_utr+") is present in collect_wo_statement which should not be there on " + fileDate);
		...
		validatation.assertFalse(invalidBDMap.containsKey(tc_31_utr),
				"The txn ("+tc_31_utr+") is present in invalid bene details which should not be there on " + fileDate);
		...
		validatation.assertFalse(payloadWpayoutMap.containsKey(tc_31_payoutref),
				"The txn ("+tc_31_payoutref+") is present in payloadWoPayout which should not be there on " + fileDate);
		...
		validatation.assertFalse(stmWmfMap.containsKey(tc_31_utr),
				"The txn ("+tc_31_utr+") is present in stmWithMissingFiled which should not be there on " + fileDate);
		...
		// valid
		validatation.assertTrue(payloadWSMap.containsKey(tc_33_payoutref),
				"The txn ("+tc_33_payoutref+") is not present in payloadWoStm which should be there on " + fileDate);
		validatation.assertTrue(payoutWSMap.containsKey(tc_33_payoutref),
				"The txn ("+tc_33_payoutref+") is not present in payoutWoStm which should be there on " + fileDate);
		// Invalid
		validatation.assertFalse(brsMap.containsKey(tc_33_utr),
				"The txn ("+tc_33_utr+") is present in the brs_complete file which should not be there on " + fileDate);
		validatation.assertFalse(cowostm.containsKey(tc_33_utr),
				"The txn ("+tc_33_utr+") is present in collect_wo_statement which should not be there on " + fileDate);
		...
		validatation.assertFalse(invalidBDMap.containsKey(tc_33_utr),
				"The txn ("+tc_33_utr+") is present in invalid bene details which should not be there on " + fileDate);
		...
		validatation.assertFalse(payloadWpayoutMap.containsKey(tc_33_payoutref),
				"The txn ("+tc_33_payoutref+") is present in payloadWoPayout which should not be there on " + fileDate);
		...
		validatation.assertFalse(stmWmfMap.containsKey(tc_33_utr),
				"The txn ("+tc_33_utr+") is present in stmWithMissingFiled which should not be there on " + fileDate);
		...
		// valid
		// Invalid
		validatation.assertFalse(brsMap.containsKey(tc_35_utr),
				"The txn ("+tc_35_utr+") is present in the brs_complete file which should not be there on " + fileDate);
		validatation.assertFalse(cowostm.containsKey(tc_35_utr),
				"The txn ("+tc_35_utr+") is present in collect_wo_statement which should not be there on " + fileDate);
		...
		validatation.assertFalse(invalidBDMap.containsKey(tc_35_utr),
				"The txn ("+tc_35_utr+") is present in invalid bene details which should not be there on " + fileDate);
		...
		validatation.assertFalse(payloadWpayoutMap.containsKey(tc_35_payoutref),
				"The txn ("+tc_35_payoutref+") is present in payloadWoPayout which should not be there on " + fileDate);
		...
		validatation.assertFalse(stmWmfMap.containsKey(tc_35_utr),
				"The txn ("+tc_35_utr+") is present in stmWithMissingFiled which should not be there on " + fileDate);
		validatation.assertFalse(payloadWSMap.containsKey(tc_35_payoutref),
				"The txn ("+tc_35_payoutref+") is present in payloadWoStm which should not be there on " + fileDate);
		...
		validatation.assertFalse(unresolvedStmMap.containsKey(tc_35_utr),
				"The txn ("+tc_35_utr+") is present in unresolvedStms which should not be there on " + fileDate);
