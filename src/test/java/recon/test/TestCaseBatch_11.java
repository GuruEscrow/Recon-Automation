...
public class TestCaseBatch_11 extends ReconTestExecution {

	@Test(priority = 11, dependsOnMethods = "batch10")
	public static void batch11() {
		...
		validatation.assertFalse(invalidSMap.containsKey(tc_1_payoutref), "The txn (" + tc_1_payoutref
				+ ") is present in invalid signature which should not be there on " + fileDate);
		...
		validatation.assertFalse(invalidBDMap.containsKey(tc_2_utr), "The txn (" + tc_2_utr
				+ ") is present in invalid bene details which should not be there on " + fileDate);
		validatation.assertFalse(invalidSMap.containsKey(tc_2_payoutref), "The txn (" + tc_2_payoutref
				+ ") is present in invalid signature which should not be there on " + fileDate);
		...
		validatation.assertFalse(invalidBDMap.containsKey(tc_3_utr), "The txn (" + tc_3_utr
				+ ") is present in invalid bene details which should not be there on " + fileDate);
		validatation.assertFalse(invalidSMap.containsKey(tc_3_payoutref), "The txn (" + tc_3_payoutref
				+ ") is present in invalid signature which should not be there on " + fileDate);
		...
		validatation.assertFalse(invalidBDMap.containsKey(tc_4_utr), "The txn (" + tc_4_utr
				+ ") is present in invalid bene details which should not be there on " + fileDate);
		validatation.assertFalse(invalidSMap.containsKey(tc_4_payoutref), "The txn (" + tc_4_payoutref
				+ ") is present in invalid signature which should not be there on " + fileDate);
		...
		validatation.assertFalse(invalidBDMap.containsKey(tc_5_utr), "The txn (" + tc_5_utr
				+ ") is present in invalid bene details which should not be there on " + fileDate);
		validatation.assertFalse(invalidSMap.containsKey(tc_5_payoutref), "The txn (" + tc_5_payoutref
				+ ") is present in invalid signature which should not be there on " + fileDate);
		...
		validatation.assertFalse(invalidBDMap.containsKey(tc_6_utr), "The txn (" + tc_6_utr
				+ ") is present in invalid bene details which should not be there on " + fileDate);
		validatation.assertFalse(invalidSMap.containsKey(tc_6_payoutref), "The txn (" + tc_6_payoutref
				+ ") is present in invalid signature which should not be there on " + fileDate);
		...
		validatation.assertFalse(invalidBDMap.containsKey(tc_8_utr), "The txn (" + tc_8_utr
				+ ") is present in invalid bene details which should not be there on " + fileDate);
		validatation.assertFalse(invalidSMap.containsKey(tc_8_payoutref), "The txn (" + tc_8_payoutref
				+ ") is present in invalid signature which should not be there on " + fileDate);
		...
		validatation.assertFalse(invalidBDMap.containsKey(tc_9_utr), "The txn (" + tc_9_utr
				+ ") is present in invalid bene details which should not be there on " + fileDate);
		validatation.assertFalse(invalidSMap.containsKey(tc_9_payoutref), "The txn (" + tc_9_payoutref
				+ ") is present in invalid signature which should not be there on " + fileDate);
		...
		validatation.assertFalse(invalidBDMap.containsKey(tc_11_utr), "The txn (" + tc_11_utr
				+ ") is present in invalid bene details which should not be there on " + fileDate);
		validatation.assertFalse(invalidSMap.containsKey(tc_11_payoutref), "The txn (" + tc_11_payoutref
				+ ") is present in invalid signature which should not be there on " + fileDate);
		...
		validatation.assertFalse(invalidBDMap.containsKey(tc_12_utr), "The txn (" + tc_12_utr
				+ ") is present in invalid bene details which should not be there on " + fileDate);
		validatation.assertFalse(invalidSMap.containsKey(tc_12_payoutref), "The txn (" + tc_12_payoutref
				+ ") is present in invalid signature which should not be there on " + fileDate);
		...
		validatation.assertFalse(invalidBDMap.containsKey(tc_14_utr), "The txn (" + tc_14_utr
				+ ") is present in invalid bene details which should not be there on " + fileDate);
		validatation.assertFalse(invalidSMap.containsKey(tc_14_payoutref), "The txn (" + tc_14_payoutref
				+ ") is present in invalid signature which should not be there on " + fileDate);
		...
		validatation.assertFalse(invalidBDMap.containsKey(tc_15_utr), "The txn (" + tc_15_utr
				+ ") is present in invalid bene details which should not be there on " + fileDate);
		validatation.assertFalse(invalidSMap.containsKey(tc_15_payoutref), "The txn (" + tc_15_payoutref
				+ ") is present in invalid signature which should not be there on " + fileDate);
		...
		validatation.assertFalse(invalidBDMap.containsKey(tc_17_utr), "The txn (" + tc_17_utr
				+ ") is present in invalid bene details which should not be there on " + fileDate);
		validatation.assertFalse(invalidSMap.containsKey(tc_17_payoutref), "The txn (" + tc_17_payoutref
				+ ") is present in invalid signature which should not be there on " + fileDate);
		...
		validatation.assertFalse(invalidBDMap.containsKey(tc_18_utr), "The txn (" + tc_18_utr
				+ ") is present in invalid bene details which should not be there on " + fileDate);
		validatation.assertFalse(invalidSMap.containsKey(tc_18_payoutref), "The txn (" + tc_18_payoutref
				+ ") is present in invalid signature which should not be there on " + fileDate);
		...
		validatation.assertFalse(invalidBDMap.containsKey(tc_19_utr), "The txn (" + tc_19_utr
				+ ") is present in invalid bene details which should not be there on " + fileDate);
		validatation.assertFalse(invalidSMap.containsKey(tc_19_payoutref), "The txn (" + tc_19_payoutref
				+ ") is present in invalid signature which should not be there on " + fileDate);
		...
		validatation.assertFalse(invalidBDMap.containsKey(tc_20_utr), "The txn (" + tc_20_utr
				+ ") is present in invalid bene details which should not be there on " + fileDate);
		validatation.assertFalse(invalidSMap.containsKey(tc_20_payoutref), "The txn (" + tc_20_payoutref
				+ ") is present in invalid signature which should not be there on " + fileDate);
		...
		validatation.assertFalse(invalidBDMap.containsKey(tc_21_utr), "The txn (" + tc_21_utr
				+ ") is present in invalid bene details which should not be there on " + fileDate);
		validatation.assertFalse(invalidSMap.containsKey(tc_21_payoutref), "The txn (" + tc_21_payoutref
				+ ") is present in invalid signature which should not be there on " + fileDate);
		...
		validatation.assertFalse(invalidBDMap.containsKey(tc_22_utr), "The txn (" + tc_22_utr
				+ ") is present in invalid bene details which should not be there on " + fileDate);
		validatation.assertFalse(invalidSMap.containsKey(tc_22_payoutref), "The txn (" + tc_22_payoutref
				+ ") is present in invalid signature which should not be there on " + fileDate);
		...
		validatation.assertFalse(invalidBDMap.containsKey(tc_23_utr), "The txn (" + tc_23_utr
				+ ") is present in invalid bene details which should not be there on " + fileDate);
		validatation.assertFalse(invalidSMap.containsKey(tc_23_payoutref), "The txn (" + tc_23_payoutref
				+ ") is present in invalid signature which should not be there on " + fileDate);
		...
		validatation.assertFalse(invalidBDMap.containsKey(tc_24_utr), "The txn (" + tc_24_utr
				+ ") is present in invalid bene details which should not be there on " + fileDate);
		validatation.assertFalse(invalidSMap.containsKey(tc_24_payoutref), "The txn (" + tc_24_payoutref
				+ ") is present in invalid signature which should not be there on " + fileDate);
		...
		validatation.assertFalse(invalidBDMap.containsKey(tc_25_utr), "The txn (" + tc_25_utr
				+ ") is present in invalid bene details which should not be there on " + fileDate);
		validatation.assertFalse(invalidSMap.containsKey(tc_25_payoutref), "The txn (" + tc_25_payoutref
				+ ") is present in invalid signature which should not be there on " + fileDate);
		...
		validatation.assertFalse(invalidBDMap.containsKey(tc_27_utr), "The txn (" + tc_27_utr
				+ ") is present in invalid bene details which should not be there on " + fileDate);
		validatation.assertFalse(invalidSMap.containsKey(tc_27_payoutref), "The txn (" + tc_27_payoutref
				+ ") is present in invalid signature which should not be there on " + fileDate);
		...
		validatation.assertFalse(invalidSMap.containsKey(tc_29_payoutref), "The txn (" + tc_29_payoutref
				+ ") is present in invalid signature which should not be there on " + fileDate);
		...
		validatation.assertFalse(invalidSMap.containsKey(tc_31_payoutref), "The txn (" + tc_31_payoutref
				+ ") is present in invalid signature which should not be there on " + fileDate);
		...
		validatation.assertFalse(invalidBDMap.containsKey(tc_33_utr), "The txn (" + tc_33_utr
				+ ") is present in invalid bene details which should not be there on " + fileDate);
		validatation.assertFalse(invalidSMap.containsKey(tc_33_payoutref), "The txn (" + tc_33_payoutref
				+ ") is present in invalid signature which should not be there on " + fileDate);
		...
		validatation.assertFalse(invalidBDMap.containsKey(tc_35_utr), "The txn (" + tc_35_utr
				+ ") is present in invalid bene details which should not be there on " + fileDate);
		validatation.assertFalse(invalidSMap.containsKey(tc_35_payoutref), "The txn (" + tc_35_payoutref
				+ ") is present in invalid signature which should not be there on " + fileDate);
		...
		validatation.assertFalse(invalidBDMap.containsKey(tc_36_utr), "The txn (" + tc_36_utr
				+ ") is present in invalid bene details which should not be there on " + fileDate);
		validatation.assertFalse(invalidSMap.containsKey(tc_36_payoutref), "The txn (" + tc_36_payoutref
				+ ") is present in invalid signature which should not be there on " + fileDate);
		...
		validatation.assertFalse(invalidBDMap.containsKey(tc_37_utr), "The txn (" + tc_37_utr
				+ ") is present in invalid bene details which should not be there on " + fileDate);
		validatation.assertFalse(invalidSMap.containsKey(tc_37_payoutref), "The txn (" + tc_37_payoutref
				+ ") is present in invalid signature which should not be there on " + fileDate);
		...
		validatation.assertFalse(invalidBDMap.containsKey(tc_38_utr), "The txn (" + tc_38_utr
				+ ") is present in invalid bene details which should not be there on " + fileDate);
		validatation.assertFalse(invalidSMap.containsKey(tc_38_payoutref), "The txn (" + tc_38_payoutref
				+ ") is present in invalid signature which should not be there on " + fileDate);
		...
		validatation.assertFalse(invalidBDMap.containsKey(tc_39_utr), "The txn (" + tc_39_utr
				+ ") is present in invalid bene details which should not be there on " + fileDate);
		validatation.assertFalse(invalidSMap.containsKey(tc_39_payoutref), "The txn (" + tc_39_payoutref
				+ ") is present in invalid signature which should not be there on " + fileDate);
		...
		validatation.assertFalse(invalidBDMap.containsKey(tc_41_utr), "The txn (" + tc_41_utr
				+ ") is present in invalid bene details which should not be there on " + fileDate);
		validatation.assertFalse(invalidSMap.containsKey(tc_41_payoutref), "The txn (" + tc_41_payoutref
				+ ") is present in invalid signature which should not be there on " + fileDate);
		...
		validatation.assertFalse(invalidBDMap.containsKey(tc_42_utr), "The txn (" + tc_42_utr
				+ ") is present in invalid bene details which should not be there on " + fileDate);
		validatation.assertFalse(invalidSMap.containsKey(tc_42_payoutref), "The txn (" + tc_42_payoutref
				+ ") is present in invalid signature which should not be there on " + fileDate);
		...
		validatation.assertFalse(payloadWSMap.containsKey(tc_43_payoutref), "The txn (" + tc_43_payoutref
				+ ") is present in payloadWoStm which should not be there on " + fileDate);
		validatation.assertFalse(payoutWSMap.containsKey(tc_43_payoutref), "The txn (" + tc_43_payoutref
				+ ") is not present in payoutWoStm which should not be there on " + fileDate);
		...
		validatation.assertFalse(invalidBDMap.containsKey(tc_43_utr), "The txn (" + tc_43_utr
				+ ") is present in invalid bene details which should not be there on " + fileDate);
		validatation.assertFalse(invalidSMap.containsKey(tc_43_payoutref), "The txn (" + tc_43_payoutref
				+ ") is present in invalid signature which should not be there on " + fileDate);
		...
		// valid
		// Invalid
		validatation.assertFalse(invalidSMap.containsKey(tc_44_payoutref), "The txn (" + tc_44_payoutref
				+ ") is present in invalid signature which should not be there on " + fileDate);
		...
		validatation.assertFalse(payloadWSMap.containsKey(tc_44_payoutref), "The txn (" + tc_44_payoutref
				+ ") is present in payloadWoStm which should not be there on " + fileDate);
		validatation.assertFalse(payoutWSMap.containsKey(tc_44_payoutref), "The txn (" + tc_44_payoutref
				+ ") is not present in payoutWoStm which should not be there on " + fileDate);
		...
		validatation.assertFalse(payloadWSMap.containsKey(tc_45_payoutref), "The txn (" + tc_45_payoutref
				+ ") is present in payloadWoStm which should not be there on " + fileDate);
		validatation.assertFalse(payoutWSMap.containsKey(tc_45_payoutref), "The txn (" + tc_45_payoutref
				+ ") is not present in payoutWoStm which should not be there on " + fileDate);
		...
		validatation.assertFalse(invalidSMap.containsKey(tc_45_payoutref), "The txn (" + tc_45_payoutref
				+ ") is present in invalid signature which should not be there on " + fileDate);
		...
		validatation.assertFalse(invalidBDMap.containsKey(tc_46_utr), "The txn (" + tc_46_utr
				+ ") is present in invalid bene details which should not be there on " + fileDate);
		validatation.assertFalse(invalidSMap.containsKey(tc_46_payoutref), "The txn (" + tc_46_payoutref
				+ ") is present in invalid signature which should not be there on " + fileDate);
		...
		validatation.assertFalse(payloadWSMap.containsKey(tc_47_payoutref), "The txn (" + tc_47_payoutref
				+ ") is present in payloadWoStm which should not be there on " + fileDate);
		validatation.assertFalse(payoutWSMap.containsKey(tc_47_payoutref), "The txn (" + tc_47_payoutref
				+ ") is not present in payoutWoStm which should not be there on " + fileDate);
		...
		validatation.assertFalse(invalidBDMap.containsKey(tc_47_utr), "The txn (" + tc_47_utr
				+ ") is present in invalid bene details which should not be there on " + fileDate);
		validatation.assertFalse(invalidSMap.containsKey(tc_47_payoutref), "The txn (" + tc_47_payoutref
				+ ") is present in invalid signature which should not be there on " + fileDate);
		...
		validatation.assertFalse(payloadWSMap.containsKey(tc_48_payoutref), "The txn (" + tc_48_payoutref
				+ ") is present in payloadWoStm which should not be there on " + fileDate);
		validatation.assertFalse(payoutWSMap.containsKey(tc_48_payoutref), "The txn (" + tc_48_payoutref
				+ ") is not present in payoutWoStm which should not be there on " + fileDate);
		...
		validatation.assertFalse(invalidBDMap.containsKey(tc_48_utr), "The txn (" + tc_48_utr
				+ ") is present in invalid bene details which should not be there on " + fileDate);
		validatation.assertFalse(invalidSMap.containsKey(tc_48_payoutref), "The txn (" + tc_48_payoutref
				+ ") is present in invalid signature which should not be there on " + fileDate);
		...
		validatation.assertFalse(payloadWSMap.containsKey(tc_49_payoutref), "The txn (" + tc_49_payoutref
				+ ") is present in payloadWoStm which should not be there on " + fileDate);
		validatation.assertFalse(payoutWSMap.containsKey(tc_49_payoutref), "The txn (" + tc_49_payoutref
				+ ") is not present in payoutWoStm which should not be there on " + fileDate);
		...
		validatation.assertFalse(invalidBDMap.containsKey(tc_49_utr), "The txn (" + tc_49_utr
				+ ") is present in invalid bene details which should not be there on " + fileDate);
		validatation.assertFalse(invalidSMap.containsKey(tc_49_payoutref), "The txn (" + tc_49_payoutref
				+ ") is present in invalid signature which should not be there on " + fileDate);
		...
		validatation.assertFalse(payloadWSMap.containsKey(tc_50_payoutref), "The txn (" + tc_50_payoutref
				+ ") is present in payloadWoStm which should not be there on " + fileDate);
		validatation.assertFalse(payoutWSMap.containsKey(tc_50_payoutref), "The txn (" + tc_50_payoutref
				+ ") is not present in payoutWoStm which should not be there on " + fileDate);
		...
		validatation.assertFalse(invalidBDMap.containsKey(tc_50_utr), "The txn (" + tc_50_utr
				+ ") is present in invalid bene details which should not be there on " + fileDate);
		validatation.assertFalse(invalidSMap.containsKey(tc_50_payoutref), "The txn (" + tc_50_payoutref
				+ ") is present in invalid signature which should not be there on " + fileDate);
		...
		// valid
		validatation.assertTrue(payloadWSMap.containsKey(tc_53_payoutref), "The txn (" + tc_53_payoutref
				+ ") is not present in payloadWoStm which should be there on " + fileDate);
		...
		// Invalid
		validatation.assertFalse(brsMap.containsKey(tc_53_utr), "The txn (" + tc_53_utr
				+ ") is present in the brs_complete file which should not be there on " + fileDate);
		validatation.assertFalse(cowostm.containsKey(tc_53_utr), "The txn (" + tc_53_utr
				+ ") is present in collect_wo_statement which should not be there on " + fileDate);
		...
		validatation.assertFalse(invalidBDMap.containsKey(tc_53_utr), "The txn (" + tc_53_utr
				+ ") is present in invalid bene details which should not be there on " + fileDate);
		validatation.assertFalse(invalidSMap.containsKey(tc_53_payoutref), "The txn (" + tc_53_payoutref
				+ ") is present in invalid signature which should not be there on " + fileDate);
		...
		validatation.assertFalse(payloadWpayoutMap.containsKey(tc_53_payoutref), "The txn (" + tc_53_payoutref
				+ ") is present in payloadWoPayout which should not be there on " + fileDate);
		...
		validatation.assertFalse(stmWmfMap.containsKey(tc_53_utr), "The txn (" + tc_53_utr
				+ ") is present in stmWithMissingFiled which should not be there on " + fileDate);
		...
		validatation.assertFalse(payloadWSMap.containsKey(tc_54_payoutref), "The txn (" + tc_54_payoutref
				+ ") is present in payloadWoStm which should not be there on " + fileDate);
		validatation.assertFalse(payoutWSMap.containsKey(tc_54_payoutref), "The txn (" + tc_54_payoutref
				+ ") is not present in payoutWoStm which should not be there on " + fileDate);
		...
		validatation.assertFalse(invalidBDMap.containsKey(tc_54_utr), "The txn (" + tc_54_utr
				+ ") is present in invalid bene details which should not be there on " + fileDate);
		validatation.assertFalse(invalidSMap.containsKey(tc_54_payoutref), "The txn (" + tc_54_payoutref
				+ ") is present in invalid signature which should not be there on " + fileDate);
		...
		validatation.assertFalse(payloadWSMap.containsKey(tc_55_payoutref), "The txn (" + tc_55_payoutref
				+ ") is present in payloadWoStm which should not be there on " + fileDate);
		validatation.assertFalse(payoutWSMap.containsKey(tc_55_payoutref), "The txn (" + tc_55_payoutref
				+ ") is not present in payoutWoStm which should not be there on " + fileDate);
		...
		validatation.assertFalse(invalidBDMap.containsKey(tc_55_utr), "The txn (" + tc_55_utr
				+ ") is present in invalid bene details which should not be there on " + fileDate);
		validatation.assertFalse(invalidSMap.containsKey(tc_55_payoutref), "The txn (" + tc_55_payoutref
				+ ") is present in invalid signature which should not be there on " + fileDate);
		...
		// valid
		// Invalid
		validatation.assertFalse(brsMap.containsKey(tc_56_utr), "The txn (" + tc_56_utr
				+ ") is present in the brs_complete file which should not be there on " + fileDate);
		...
		validatation.assertFalse(payloadWSMap.containsKey(tc_56_payoutref), "The txn (" + tc_56_payoutref
				+ ") is present in payloadWoStm which should not be there on " + fileDate);
		validatation.assertFalse(payoutWSMap.containsKey(tc_56_payoutref), "The txn (" + tc_56_payoutref
				+ ") is not present in payoutWoStm which should not be there on " + fileDate);
		...
		validatation.assertFalse(invalidBDMap.containsKey(tc_56_utr), "The txn (" + tc_56_utr
				+ ") is present in invalid bene details which should not be there on " + fileDate);
		validatation.assertFalse(invalidSMap.containsKey(tc_56_payoutref), "The txn (" + tc_56_payoutref
				+ ") is present in invalid signature which should not be there on " + fileDate);
		...
		// valid
		// Invalid
		validatation.assertFalse(brsMap.containsKey(tc_57_utr), "The txn (" + tc_57_utr
				+ ") is present in the brs_complete file which should not be there on " + fileDate);
		validatation.assertFalse(payloadWSMap.containsKey(tc_57_payoutref), "The txn (" + tc_57_payoutref
				+ ") is present in payloadWoStm which should not be there on " + fileDate);
		validatation.assertFalse(payoutWSMap.containsKey(tc_57_payoutref), "The txn (" + tc_57_payoutref
				+ ") is not present in payoutWoStm which should not be there on " + fileDate);
		...
		validatation.assertFalse(invalidBDMap.containsKey(tc_57_utr), "The txn (" + tc_57_utr
				+ ") is present in invalid bene details which should not be there on " + fileDate);
		validatation.assertFalse(invalidSMap.containsKey(tc_57_payoutref), "The txn (" + tc_57_payoutref
				+ ") is present in invalid signature which should not be there on " + fileDate);
		...
		// valid
		// Invalid
		validatation.assertFalse(brsMap.containsKey(tc_60_utr), "The txn (" + tc_60_utr
				+ ") is present in the brs_complete file which should not be there on " + fileDate);
		validatation.assertFalse(payloadWSMap.containsKey(tc_60_payoutref), "The txn (" + tc_60_payoutref
				+ ") is present in payloadWoStm which should not be there on " + fileDate);
		validatation.assertFalse(payoutWSMap.containsKey(tc_60_payoutref), "The txn (" + tc_60_payoutref
				+ ") is not present in payoutWoStm which should not be there on " + fileDate);
		...
		validatation.assertFalse(invalidBDMap.containsKey(tc_60_utr), "The txn (" + tc_60_utr
				+ ") is present in invalid bene details which should not be there on " + fileDate);
		validatation.assertFalse(invalidSMap.containsKey(tc_60_payoutref), "The txn (" + tc_60_payoutref
				+ ") is present in invalid signature which should not be there on " + fileDate);
