...
public class TestCaseBatch_4 extends ReconTestExecution {

	@Test(priority = 4, dependsOnMethods = "batch3")
	public static void batch4() {
		...
		// valid
		validatation.assertTrue(brsMap.containsKey(tc_3_utr), "The txn (" + tc_3_utr
				+ ") is not present in the brs_complete file which should be there on " + fileDate);
		validatation.assertTrue(powoplMap.containsKey(tc_3_utr),
				"The txn (" + tc_3_utr + ") is not present in payoutWoPayload which should be there on " + fileDate);
		...
		// valid
		validatation.assertTrue(brsMap.containsKey(tc_6_utr), "The txn (" + tc_6_utr
				+ ") is not present in the brs_complete file which should be there on " + fileDate);
		validatation.assertTrue(powoplMap.containsKey(tc_6_utr),
				"The txn (" + tc_6_utr + ") is present not payoutWoPayload which should be there on " + fileDate);
		// Invalid
		...
		// valid
		validatation.assertTrue(payloadWSMap.containsKey(tc_14_payoutref), "The txn (" + tc_14_payoutref
		...
		// valid
		validatation.assertTrue(payloadWSMap.containsKey(tc_17_payoutref), "The txn (" + tc_17_payoutref
				+ ") is not present in payloadWoStm which should be there on " + fileDate);
		...
		// valid
		validatation.assertTrue(payloadWSMap.containsKey(tc_18_payoutref), "The txn (" + tc_18_payoutref
				+ ") is not present in payloadWoStm which should be there on " + fileDate);
		...
		// valid
		validatation.assertTrue(payloadWSMap.containsKey(tc_19_payoutref), "The txn (" + tc_19_payoutref
				+ ") is not present in payloadWoStm which should be there on " + fileDate);
		...
		// valid
		validatation.assertTrue(payloadWSMap.containsKey(tc_20_payoutref), "The txn (" + tc_20_payoutref
				+ ") is not present in payloadWoStm which should be there on " + fileDate);
		...
		// valid
		validatation.assertTrue(payloadWSMap.containsKey(tc_21_payoutref), "The txn (" + tc_21_payoutref
				+ ") is not present in payloadWoStm which should be there on " + fileDate);
		...
		// valid
		validatation.assertTrue(payloadWSMap.containsKey(tc_22_payoutref), "The txn (" + tc_22_payoutref
				+ ") is not present in payloadWoStm which should be there on " + fileDate);
		...
		// valid
		validatation.assertTrue(payloadWSMap.containsKey(tc_23_payoutref), "The txn (" + tc_23_payoutref
				+ ") is not present in payloadWoStm which should be there on " + fileDate);
		...
		// valid
		validatation.assertTrue(payloadWSMap.containsKey(tc_25_payoutref), "The txn (" + tc_25_payoutref
				+ ") is not present in payloadWoStm which should be there on " + fileDate);
		...
		// valid
		validatation.assertTrue(payloadWSMap.containsKey(tc_27_payoutref), "The txn (" + tc_27_payoutref
				+ ") is not present in payloadWoStm which should be there on " + fileDate);
		...
		// valid
		validatation.assertTrue(payloadWSMap.containsKey(tc_29_payoutref), "The txn (" + tc_29_payoutref
				+ ") is not present in payloadWoStm which should be there on " + fileDate);
		...
		validatation.assertFalse(invalidBDMap.containsKey(tc_29_utr), "The txn (" + tc_29_utr
				+ ") is present in invalid bene details which should not be there on " + fileDate);
		...
		// valid
		validatation.assertTrue(payloadWSMap.containsKey(tc_31_payoutref), "The txn (" + tc_31_payoutref
				+ ") is not present in payloadWoStm which should be there on " + fileDate);
		...
		// valid
		validatation.assertTrue(payloadWSMap.containsKey(tc_33_payoutref), "The txn (" + tc_33_payoutref
				+ ") is not present in payloadWoStm which should be there on " + fileDate);
