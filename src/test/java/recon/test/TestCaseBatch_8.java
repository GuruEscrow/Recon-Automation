...
public class TestCaseBatch_8 extends ReconTestExecution {

	@Test(priority = 8, dependsOnMethods = "batch7")
	public static void batch8() {
		...
		//Valid
		validatation.assertTrue(brsMap.containsKey(tc_36_utr),
				"The txn ("+tc_36_utr+") is not present in the brs_complete file which should be there on " + fileDate);
		// Invalid
		validatation.assertFalse(cowostm.containsKey(tc_36_utr),
				"The txn ("+tc_36_utr+") is present in collect_wo_statement which should not be there on " + fileDate);
		...
		validatation.assertFalse(invalidBDMap.containsKey(tc_36_utr),
				"The txn ("+tc_36_utr+") is present in invalid bene details which should not be there on " + fileDate);
		validatation.assertFalse(invalidSMap.containsKey(tc_36_utr),
				"The txn ("+tc_36_utr+") is present in invalid signature which should not be there on " + fileDate);
		...
		validatation.assertFalse(payloadWpayoutMap.containsKey(tc_36_payoutref),
				"The txn ("+tc_36_payoutref+") is present in payloadWoPayout which should not be there on " + fileDate);
		validatation.assertFalse(payloadWSMap.containsKey(tc_36_payoutref),
				"The txn ("+tc_36_payoutref+") is present in payloadWoStm which should not be there on " + fileDate);
		...
		validatation.assertFalse(stmWmfMap.containsKey(tc_36_utr),
				"The txn ("+tc_36_utr+") is present in stmWithMissingFiled which should not be there on " + fileDate);
		...
		//Valid
		validatation.assertTrue(brsMap.containsKey(tc_37_utr),
				"The txn ("+tc_37_utr+") is not present in the brs_complete file which should be there on " + fileDate);
		// Invalid
		validatation.assertFalse(cowostm.containsKey(tc_37_utr),
				"The txn ("+tc_37_utr+") is present in collect_wo_statement which should not be there on " + fileDate);
		...
		validatation.assertFalse(invalidBDMap.containsKey(tc_37_utr),
				"The txn ("+tc_37_utr+") is present in invalid bene details which should not be there on " + fileDate);
		validatation.assertFalse(invalidSMap.containsKey(tc_37_utr),
				"The txn ("+tc_37_utr+") is present in invalid signature which should not be there on " + fileDate);
		...
		validatation.assertFalse(payloadWpayoutMap.containsKey(tc_37_payoutref),
				"The txn ("+tc_37_payoutref+") is present in payloadWoPayout which should not be there on " + fileDate);
		validatation.assertFalse(payloadWSMap.containsKey(tc_37_payoutref),
				"The txn ("+tc_37_payoutref+") is present in payloadWoStm which should not be there on " + fileDate);
		...
		validatation.assertFalse(stmWmfMap.containsKey(tc_37_utr),
				"The txn ("+tc_37_utr+") is present in stmWithMissingFiled which should not be there on " + fileDate);
		...
		//Valid
		validatation.assertTrue(brsMap.containsKey(tc_38_utr),
				"The txn ("+tc_38_utr+") is not present in the brs_complete file which should be there on " + fileDate);
		validatation.assertTrue(fpwmore2stmMap.containsKey(tc_38_utr),
				"The txn ("+tc_38_utr+") is not present in fpwmore2stm which should be there on " + fileDate);
		...
		// Invalid
		validatation.assertFalse(cowostm.containsKey(tc_38_utr),
				"The txn ("+tc_38_utr+") is present in collect_wo_statement which should not be there on " + fileDate);
		validatation.assertFalse(invalidBDMap.containsKey(tc_38_utr),
				"The txn ("+tc_38_utr+") is present in invalid bene details which should not be there on " + fileDate);
		validatation.assertFalse(invalidSMap.containsKey(tc_38_utr),
				"The txn ("+tc_38_utr+") is present in invalid signature which should not be there on " + fileDate);
		...
		validatation.assertFalse(payloadWpayoutMap.containsKey(tc_38_payoutref),
				"The txn ("+tc_38_payoutref+") is present in payloadWoPayout which should not be there on " + fileDate);
		validatation.assertFalse(payloadWSMap.containsKey(tc_38_payoutref),
				"The txn ("+tc_38_payoutref+") is present in payloadWoStm which should not be there on " + fileDate);
		...
		validatation.assertFalse(stmWmfMap.containsKey(tc_38_utr),
				"The txn ("+tc_38_utr+") is present in stmWithMissingFiled which should not be there on " + fileDate);
		...
		//Valid
		validatation.assertTrue(payloadWpayoutMap.containsKey(tc_39_payoutref),
				"The txn ("+tc_39_payoutref+") is not present in payloadWoPayout which should be there on " + fileDate);
		// Invalid
		validatation.assertFalse(brsMap.containsKey(tc_39_utr),
				"The txn ("+tc_39_utr+") is present in the brs_complete file which should not be there on " + fileDate);
		validatation.assertFalse(cowostm.containsKey(tc_39_utr),
				"The txn ("+tc_39_utr+") is present in collect_wo_statement which should not be there on " + fileDate);
		...
		validatation.assertFalse(invalidBDMap.containsKey(tc_39_utr),
				"The txn ("+tc_39_utr+") is present in invalid bene details which should not be there on " + fileDate);
		validatation.assertFalse(invalidSMap.containsKey(tc_39_utr),
				"The txn ("+tc_39_utr+") is present in invalid signature which should not be there on " + fileDate);
		...
		validatation.assertFalse(payloadWSMap.containsKey(tc_39_payoutref),
				"The txn ("+tc_39_payoutref+") is present in payloadWoStm which should not be there on " + fileDate);
		...
		validatation.assertFalse(stmWmfMap.containsKey(tc_39_utr),
				"The txn ("+tc_39_utr+") is present in stmWithMissingFiled which should not be there on " + fileDate);
		...
		//Valid
		validatation.assertTrue(stmWmfMap.containsKey(tc_40_serialNum),
				"The txn ("+tc_40_serialNum+") is not present in stmWithMissingFiled which should be there on " + fileDate);
		
		/* TC-41 */
		String tc_41_utr = "419811423515";
		String tc_41_payoutref = "20240716115603GuruLiveImps182";
		//Valid
		validatation.assertTrue(brsMap.containsKey(tc_41_utr),
				"The txn ("+tc_41_utr+") is not present in the brs_complete file which should be there on " + fileDate);
		validatation.assertTrue(payoutWCMap.containsKey(tc_41_utr),
				"The txn ("+tc_41_utr+") is not present in payoutWoCredit which should be there on " + fileDate);
		// Invalid
		validatation.assertFalse(cowostm.containsKey(tc_41_utr),
				"The txn ("+tc_41_utr+") is present in collect_wo_statement which should not be there on " + fileDate);
		...
		validatation.assertFalse(invalidBDMap.containsKey(tc_41_utr),
				"The txn ("+tc_41_utr+") is present in invalid bene details which should not be there on " + fileDate);
		validatation.assertFalse(invalidSMap.containsKey(tc_41_utr),
				"The txn ("+tc_41_utr+") is present in invalid signature which should not be there on " + fileDate);
		...
		validatation.assertFalse(payloadWpayoutMap.containsKey(tc_41_payoutref),
				"The txn ("+tc_41_payoutref+") is present in payloadWoPayout which should not be there on " + fileDate);
		validatation.assertFalse(payloadWSMap.containsKey(tc_41_payoutref),
				"The txn ("+tc_41_payoutref+") is present in payloadWoStm which should not be there on " + fileDate);
		...
		validatation.assertFalse(stmWmfMap.containsKey(tc_41_utr),
				"The txn ("+tc_41_utr+") is present in stmWithMissingFiled which should not be there on " + fileDate);
		...
		//Valid
		validatation.assertTrue(brsMap.containsKey(tc_42_utr),
				"The txn ("+tc_42_utr+") is not present in the brs_complete file which should be there on " + fileDate);
		...
		// Invalid
		validatation.assertFalse(cowostm.containsKey(tc_42_utr),
				"The txn ("+tc_42_utr+") is present in collect_wo_statement which should not be there on " + fileDate);
		...
		validatation.assertFalse(invalidBDMap.containsKey(tc_42_utr),
				"The txn ("+tc_42_utr+") is present in invalid bene details which should not be there on " + fileDate);
		validatation.assertFalse(invalidSMap.containsKey(tc_42_utr),
				"The txn ("+tc_42_utr+") is present in invalid signature which should not be there on " + fileDate);
		...
		validatation.assertFalse(payloadWpayoutMap.containsKey(tc_42_payoutref),
				"The txn ("+tc_42_payoutref+") is present in payloadWoPayout which should not be there on " + fileDate);
		validatation.assertFalse(payloadWSMap.containsKey(tc_42_payoutref),
				"The txn ("+tc_42_payoutref+") is present in payloadWoStm which should not be there on " + fileDate);
		...
		validatation.assertFalse(stmWmfMap.containsKey(tc_42_utr),
				"The txn ("+tc_42_utr+") is present in stmWithMissingFiled which should not be there on " + fileDate);
		...
		// valid
		validatation.assertTrue(payloadWSMap.containsKey(tc_43_payoutref),
				"The txn ("+tc_43_payoutref+") is not present in payloadWoStm which should be there on " + fileDate);
		validatation.assertTrue(payoutWSMap.containsKey(tc_43_payoutref),
				"The txn ("+tc_43_payoutref+") is not present in payoutWoStm which should be there on " + fileDate);
		// Invalid
		validatation.assertFalse(brsMap.containsKey(tc_43_utr),
				"The txn ("+tc_43_utr+") is present in the brs_complete file which should not be there on " + fileDate);
		validatation.assertFalse(cowostm.containsKey(tc_43_utr),
				"The txn ("+tc_43_utr+") is present in collect_wo_statement which should not be there on " + fileDate);
		...
		validatation.assertFalse(invalidBDMap.containsKey(tc_43_utr),
				"The txn ("+tc_43_utr+") is present in invalid bene details which should not be there on " + fileDate);
		validatation.assertFalse(invalidSMap.containsKey(tc_43_utr),
				"The txn ("+tc_43_utr+") is present in invalid signature which should not be there on " + fileDate);
		...
		validatation.assertFalse(payloadWpayoutMap.containsKey(tc_43_payoutref),
				"The txn ("+tc_43_payoutref+") is present in payloadWoPayout which should not be there on " + fileDate);
		...
		validatation.assertFalse(stmWmfMap.containsKey(tc_43_utr),
				"The txn ("+tc_43_utr+") is present in stmWithMissingFiled which should not be there on " + fileDate);
