...
public class TestCaseBatch_7 extends ReconTestExecution {

	@Test(priority = 7, dependsOnMethods = "batch6")
	public static void batch7() {
		...
		// valid
		validatation.assertTrue(brsMap.containsKey(tc_15_utr), "The txn (" + tc_15_utr
		...
		// valid
		validatation.assertTrue(brsMap.containsKey(tc_18_utr), "The txn (" + tc_18_utr
				+ ") is not present in the brs_complete file which should be there on " + fileDate);
		// Invalid
