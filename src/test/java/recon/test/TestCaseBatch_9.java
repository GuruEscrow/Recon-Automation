...
public class TestCaseBatch_9 extends ReconTestExecution {

	@Test(priority = 9, dependsOnMethods = "batch8")
	public static void batch9() {
		...
		// Valid
		validatation.assertTrue(brsMap.containsKey(tc_41_utr), "The txn (" + tc_41_utr
		...
		// valid
		validatation.assertTrue(brsMap.containsKey(tc_43_utr), "The txn (" + tc_43_utr
				+ ") is not present in the brs_complete file which should be there on " + fileDate);
		// Invalid
		...
		// valid
		validatation.assertTrue(invalidSMap.containsKey(tc_44_payoutref),
				"The txn (" + tc_44_payoutref + ") is not present in invalid signature which should be there on " + fileDate);
		// Invalid
		...
		// valid
		validatation.assertTrue(invalidBDMap.containsKey(tc_45_utr), "The txn (" + tc_45_utr
		...
		// Valid
		validatation.assertTrue(brsMap.containsKey(tc_46_utr), "The txn (" + tc_46_utr
				+ ") is not present in the brs_complete file which should be there on " + fileDate);
		validatation.assertTrue(ppwmore1stmMap.containsKey(tc_46_utr),
				"The txn (" + tc_46_utr + ") is not present in ppwmore1stm which should be there on " + fileDate);
		...
		// valid
		validatation.assertTrue(brsMap.containsKey(tc_47_utr), "The txn (" + tc_47_utr
				+ ") is not present in the brs_complete file which should be there on " + fileDate);
		// Invalid
		...
		// valid
		validatation.assertTrue(brsMap.containsKey(tc_48_utr), "The txn (" + tc_48_utr
				+ ") is not present in the brs_complete file which should be there on " + fileDate);
		// Invalid
		...
		// valid
		validatation.assertTrue(brsMap.containsKey(tc_49_utr), "The txn (" + tc_49_utr
				+ ") is not present in the brs_complete file which should be there on " + fileDate);
		...
		// valid
		validatation.assertTrue(brsMap.containsKey(tc_54_utr), "The txn (" + tc_54_utr
				+ ") is not present in the brs_complete file which should be there on " + fileDate);
		...
		// valid
		validatation.assertTrue(brsMap.containsKey(tc_55_utr), "The txn (" + tc_55_utr
				+ ") is not present in the brs_complete file which should be there on " + fileDate);
		// Invalid
		...
		// valid
		validatation.assertTrue(cowostm.containsKey(tc_56_utr), "The txn (" + tc_56_utr
				+ ") is not present in collect_wo_statement which should be there on " + fileDate);
		// Invalid
		...
		// valid
		validatation.assertTrue(brsMap.containsKey(tc_58_utr), "The txn (" + tc_58_utr
				+ ") is not present in the brs_complete file which should be there on " + fileDate);
